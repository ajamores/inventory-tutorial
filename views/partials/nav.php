            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/notes"
                            class="<?=  urlIs('/notes') ? 'rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white' : 'rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white'; ?>">Notes</a>
                        <?php endif ?>
                        <a href="/contact"
            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <el-dropdown class="relative ml-3">
                        ...
                        <?php else : ?>
                        <a href="/register"
                            class="<?=  urlIs('/register') ? 'rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white' : 'rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white'; ?>">Register</a>
                        <a href="/login"
                            class="<?=  urlIs('/login') ? 'rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white' : 'rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white'; ?>">Login</a>
                    ...
                    <div class="ml-3">
                        <form action="/session" method="POST">
                            ...
                            <button
                                class="<?=  urlIs('/login') ? 'rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white' : 'rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white'; ?>">
                                Log Out</button>
                        </form>
                    </div>
